...
@section('content')
    <div class=" overflow-x-auto shadow-md sm:rounded-lg w-full">
        <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 ">
            <a href="{{route('admin.product.create') }}">افزودن جدید</a>
        </button>
        @if ($products->isEmpty())
            ...
            @foreach ($products as $product)
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4 text-right">
                        <a href="{{ route('admin.product.edit', $product->id) }}" class="font-medium text-blue-600 hover:underline">ویرایش</a>
                        <a href="{{ route('admin.product.show', $product->id) }}" class="font-medium text-blue-600 hover:underline">نمایش</a>
