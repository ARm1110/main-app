                ...
                <div class="cart-content shadow-box">
                    <div class="payment">
                        <div class="payment-title">
                            <img src="{{asset('storage/asset/img/default-icon/iconNok.jpg')}}" alt="" width="100" class="img-fluid m-auto">
                    ...
                    <div class="category-filter">
                        <div class="category-filter-box">
                            <div class="category-filter-box-title">
                                ...
                                <p class="text-muted my-2 font-14 text-payment">سفارش شما با موفقیت در سیستم ثبت شد و هم اکنون <span class="danger-span">در انتظار پرداخت</span> است
                                    جزییات این سفارش را میتوانید با کلیک بر روی دکمه <a href=""><span class="danger-span-border">پیگیری سفارش</span></a> مشاهده نمایید
                                </p>
                            </div>
