                                ...
                                <div class="offer-item">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="offer-img">
                                                <img src="{{asset('storage/asset/img/product/wach1.jpg')}}" alt="" class="img-fluid">
                                        ...
                                        <div class="col-md-6">
                                            <div class="offer-content">
                                                ...
                                                <div class="offer-desc">
                                                    <div class="se-title">
                                                        <h5>گوشی موبایل شیائومی مدل Poco M4 Pro 5G دو سیم کارت
                                                            ظرفیت 128/6 گیگابایت
                                                        </h5>
                                                        <h6 class="text-muted">Xiaomi Poco M4 Pro 5G Dual SIM
                                                ...
                                                <div class="offer-btn">
                                                    <a href="product.html"><i class="bi bi-cart-plus"></i> بریم
                                                        واسه
                                                        خرید!</i></a>
                                                </div>
                                            </div>
                                ...
                                <div class="offer-item">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="offer-img">
                                                <img src="{{asset('storage/asset/img/product/wach2.jpg')}}" alt="" class="img-fluid">
                                                <div class='countdown' data-date="2028-01-01" data-time="18:30">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="offer-item">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="offer-img">
                                                <img src="{{asset('storage/asset/img/product/wach3.jpg')}}" alt="" class="img-fluid">
                                                <div class='countdown' data-date="2028-01-01" data-time="18:30">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="offer-item">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="offer-img">
                                                <img src="{{asset('storage/asset/img/product/wach4.jpg')}}" alt="" class="img-fluid">
                                                <div class='countdown' data-date="2028-01-01" data-time="18:30">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="offer-item">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="offer-img">
                                                <img src="{{asset('storage/asset/img/product/product-image1.jpg')}} " alt="" class="img-fluid">
                                                <div class='countdown' data-date="2028-01-01" data-time="18:30">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="offer-item">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="offer-img">
                                                <img src="{{asset('storage/asset/img/product/television1.jpg')}}" alt="" class="img-fluid">
                                                <div class='countdown' data-date="2028-01-01" data-time="18:30">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="offer-item">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="offer-img">
                                                <img src="{{asset('storage/asset/img/product/television2.jpg')}}" alt="" class="img-fluid">
                                                <div class='countdown' data-date="2028-01-01" data-time="18:30">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="offer-item">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="offer-img">
                                                <img src="{{asset('storage/asset/img/product/product-image3.jpg')}}" alt="" class="img-fluid">
                                                <div class='countdown' data-date="2028-01-01" data-time="18:30">
                                                </div>
                                            </div>
                                        </div>
