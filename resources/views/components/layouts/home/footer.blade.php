            ...
            <div class="row justify-content-center">
                <div class="col-md-3 col-6 text-center">
                    <div class="footer-feature-item">
                        <a href="">
                            <img src="{{ asset('storage/asset/img/product-feature/delivery.png')  }}" alt="">
                        </a>
                        <h6>تحویل اکسپرس</h6>
                    </div>
                </div>
                <div class="col-md-3 col-6 text-center">
                    <div class="footer-feature-item">
                        <a href="">
                            <img src="{{ asset('storage/asset/img/product-feature/contact-us.png')  }}" alt="">
                        </a>
                ...
                <div class="col-md-3 col-6 text-center">
                    <div class="footer-feature-item">
                        <a href="">
                            <img src="{{ asset('storage/asset/img/product-feature/payment-terms.png')  }}" alt="">
                        </a>
                        <h6>پرداخت در محل</h6>
                    </div>
                </div>
                <div class="col-md-3 col-6 text-center">
                    <div class="footer-feature-item">
                        <a href="">
                            <img src="{{ asset('storage/asset/img/product-feature/return-policy.png')  }}" alt="">
                        </a>
        ...
        <div class="footer">
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="footer-item">
                        <h5>با رستا</h5>
                        <ul class="footer-item-link">
                            <li><a href="">فروش در رستا</a></li>
                            <li><a href="">همکاری با سازمان ها</a></li>
                            <li><a href="">فرصت های شغلی</a></li>
                            <li><a href="">تماس با رستا</a></li>
                            <li><a href="">درباره مصباج</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="footer-item">
                        <div class="feed">
                            <h6>از تخفیف‌ها فروشگاه باخبر شوید:
                            </h6>
                            <form action="">
                        ...
                        <div class="footer-desc-item">
                            <ul class="d-flex justify-content-md-end justify-content-center">
                                <li><a href=""><img src="{{ asset('storage/asset/img/default-icon/enamad.png')  }}" alt=""></a></li>
                                <li><a href=""><img src="{{ asset('storage/asset/img/default-icon/kasbokar.png')  }}" alt=""></a></li>
                                <li><a href=""><img src="{{ asset('storage/asset/img/default-icon/rezi.png')  }}" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer-desc">
                <div class="row">
                    <div class="col-12">
                        <div class="footer-desc-item">
                            <h3>فروشگاه رستا ، بررسی ، انتخاب و خرید آنلاین</h3>
                            <p class="text-muted">
                                ...
                                کالا
                                هم داشته باشد؛ ویژگی‌هایی که فروشگاه اینترنتی رستا سال‌هاست بر روی آن‌ها کار
                                کرده و
                    ...
                    <div class="row pe-0">
                        ...
                        <div class="d-flex align-items-center justify-content-sm-end justify-content-center flex-wrap mt-sm-0 mt-3">
                            <a href=""><img src="{{asset('storage/asset/img/default-icon/bazaar.png')}}" class="img-fluid mt-sm-0 mt-2"
                                            width="150" alt=""></a>
                            <a href="">
                                <img src="{{asset('storage/asset/img/default-icon/sibapp.png')}}"
...
<div class="copy-right bg-white">
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-md-8">
                <p class="text-muted text-center mb-sm-0 mb-3">برای استفاده از مطالب فروشگاه، داشتن «هدف غیرتجاری» و
                    ذکر «منبع» کافیست.
                    تمام
                    حقوق اين وب‌سايت نیز برای شرکت رستا است.
                </p>
            </div>
            <div class="col-md-4">
